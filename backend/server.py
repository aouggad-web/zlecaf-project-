...
async def get_country_profile(country_code: str) -> CountryEconomicProfile:
    ...
    profile.gdp_africa_rank = real_data.get('gdp_africa_rank')
    profile.source_urls = real_data.get('source_urls')
    ...
    profile.projections = {
        ...
        "business_environment_rank": real_data.get('gdp_africa_rank', None)
    }
...
async def calculate_comprehensive_tariff(request: TariffCalculationRequest):
    ...
    result = TariffCalculationResponse(
        ...
        normal_other_taxes=0.0,
        zlecaf_other_taxes=0.0,
        normal_handling_fees=0.0,
        zlecaf_handling_fees=0.0,
